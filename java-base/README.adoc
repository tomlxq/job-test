...
[source,java]
----
include::{book-root}/src/main/java/spring_IOC/JavaBean.java[]
----
...
[source,java]
----
include::{book-root}/src/main/java/spring_IOC/SetValueByReflection.java[]
----
...
[source,java]
----
include::{book-root}/src/main/java/spring_IOC/SetValueByReflectionLoop.java[]
----
...
[source,xml]
----
include::{book-root}/src/main/resources/config.xml[]
----
...
[source,java]
----
include::{book-root}/src/main/java/spring_IOC/BeanFactory.java[]
----
